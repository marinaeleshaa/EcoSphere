      ...
      <div className="mx-auto w-[80%] px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute ring-2 ring-primary/40 dark:ring-primary/60 -bottom-6 -right-4 z-20 md:-bottom-10 md:-right-10 w-48 md:w-64 bg-background p-3 rounded-xl shadow-2xl  ">
