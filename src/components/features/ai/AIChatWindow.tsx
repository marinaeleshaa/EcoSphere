...
export const AIChatWindow: React.FC<AIChatWindowProps> = ({
  ...
  return (
    <div className={cn(
      "fixed bottom-24 right-6 w-[90vw] md:w-[400px] h-[600px] max-h-[75vh] bg-card text-card-foreground",
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-4 bg-muted/30 scrollbar-thin scrollbar-thumb-muted-foreground/20">
        {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center p-6 text-muted-foreground">
                ...
                <p className="text-sm mt-2 opacity-75">{t('emptyState.subtitle')}</p>
            </div>
        )}
      ...
      <div className="p-4 bg-card border-t border-border shrink-0">
        <div className="relative flex items-end gap-2">
          <textarea
            ...
            className="flex-1 myInput resize-none max-h-32 min-h-[48px]"
            rows={1}
