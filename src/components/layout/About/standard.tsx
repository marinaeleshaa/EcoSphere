          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="space-y-6 text-muted text-lg leading-relaxed">
                ...
                <p>
                  We utilize a combination of documentation review, assessment of 
                  third-party certifications (where applicable), and a detailed 
                  questionnaire to assess true impact across four key pillars.
                </p>
